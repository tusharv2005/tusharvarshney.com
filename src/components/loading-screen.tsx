  ...
  return (
    <>
      <div
        ...
        style={{
          maskImage: `url("data:image/svg+xml,%3Csvg viewBox='0 0 100 100' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='${starPath}' fill='white'/%3E%3C/svg%3E")`,
          maskSize: isExpanding ? "500vmax 500vmax" : "12rem 12rem",
          maskPosition: "center",
          maskRepeat: "no-repeat",
          WebkitMaskImage: `url("data:image/svg+xml,%3Csvg viewBox='0 0 100 100' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='${starPath}' fill='white'/%3E%3C/svg%3E")`,
      ...
      <div className="pointer-events-none fixed inset-0 z-[10000] flex items-center justify-center">
        <div
          ...
          style={{
            width: isExpanding ? "500vmax" : "12rem",
            height: isExpanding ? "500vmax" : "12rem",
