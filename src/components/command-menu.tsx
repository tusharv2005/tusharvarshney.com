      ...
      <CommandDialog open={open} onOpenChange={setOpen}>
        ...
        <CommandList className="min-h-80 supports-timeline-scroll:scroll-fade-effect-y">
          ...
          <CommandGroup heading="Brand Assets">
            ...
            <CommandItem onSelect={() => handleOpenLink("/blog/tushar-brand")}>
              <SquareDashed />
              Brand Guidelines
            </CommandItem>
            ...
            <CommandItem asChild>
              <a
                href="https://assets.tusharvarshney.com/tushar-brand.zip"
                download
              >
                <Download />
  ...
  return (
    <>
      ...
      <div className="absolute inset-x-0 bottom-0 flex h-10 items-center justify-between gap-2 rounded-b-2xl border-t px-4 text-xs font-medium">
        <TusharMark className="size-6 text-muted-foreground" />
