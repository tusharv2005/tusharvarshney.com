...
image: https://assets.tusharvarshney.com/images/blog/writing-effect-inspired-by-apple.webp
category: components
...
<ComponentPreview
  ...
  openInV0Url="https://tusharvarshney.com/r/apple-hello-effect.json"
  canReplay
/>
...
```bash
npx shadcn@latest add @tusharvarshney/apple-hello-effect
```

For Hindi:

```bash
npx shadcn@latest add @tusharvarshney/apple-hello-effect-hindi
```

For Spanish:

```bash
npx shadcn@latest add @tusharvarshney/apple-hello-effect-spanish
```

For Vietnamese:

```bash
npx shadcn@latest add @tusharvarshney/apple-hello-effect-vietnamese
```
