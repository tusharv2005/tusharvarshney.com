...
image: https://assets.tusharvarshney.com/images/blog/toc-minimap.webp
category: components
new: true
...
<ComponentPreview
  ...
  openInV0Url="https://tusharvarshney.com/r/toc-minimap.json"
/>
...
```bash
npx shadcn@latest add @tusharvarshney/toc-minimap
```
