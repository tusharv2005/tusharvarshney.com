...
image: https://assets.tusharvarshney.com/images/blog/work-experience-component.webp?t=1750149861
category: components
...
<ComponentPreview
  ...
  openInV0Url="https://tusharvarshney.com/r/work-experience.json"
  prose
/>
...
```bash
npx shadcn@latest add @tusharvarshney/work-experience
```
