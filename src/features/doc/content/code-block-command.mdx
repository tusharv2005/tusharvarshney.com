...
image: https://assets.tusharvarshney.com/images/blog/code-block-command.webp
category: components
...
<ComponentPreview
  ...
  openInV0Url="https://tusharvarshney.com/r/code-block-command.json"
/>
...
```bash
npx shadcn@latest add @tusharvarshney/code-block-command
```
...
- [Copy Button](https://tusharvarshney.com/components/copy-button)
...
```tsx
<CodeBlockCommand
  prompt="Add the @tusharvarshney/code-block-command component to my project"
  pnpm="pnpm dlx shadcn add @tusharvarshney/code-block-command"
  yarn="yarn dlx shadcn add @tusharvarshney/code-block-command"
...
<CodeBlockCommand
  prompt="Add the @tusharvarshney/code-block-command component to my project"
  {...convertNpmCommand("npx shadcn add @tusharvarshney/code-block-command")}
/>
```
