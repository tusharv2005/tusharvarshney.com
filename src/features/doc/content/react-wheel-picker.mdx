...
image: https://assets.tusharvarshney.com/images/blog/react-wheel-picker.webp?t=1747747932
category: components
...
<ComponentPreview
  ...
  openInV0Url="https://tusharvarshney.com/r/wheel-picker.json"
/>

## Features

Built on top of [React Wheel Picker](https://react-wheel-picker.tusharvarshney.com).
...
```bash
npx shadcn@latest add @tusharvarshney/wheel-picker
```
...
```bash
npm install @tusharvarshney/react-wheel-picker clsx tailwind-merge
```
...
See the [React Wheel Picker](https://react-wheel-picker.tusharvarshney.com/docs/getting-started) documentation for more information.
