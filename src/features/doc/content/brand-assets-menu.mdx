...
image: https://assets.tusharvarshney.com/images/blog/brand-assets-menu.webp
category: components
new: true
...
<ComponentPreview
  ...
  openInV0Url="https://tusharvarshney.com/r/brand-assets-menu.json"
/>
...
```bash
npx shadcn@latest add @tusharvarshney/brand-assets-menu
```
