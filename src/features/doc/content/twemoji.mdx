...
image: https://assets.tusharvarshney.com/images/blog/twemoji.webp
category: components
...
<ComponentPreview
  name="twemoji-demo"
  openInV0Url="https://tusharvarshney.com/r/twemoji.json"
/>
...
```bash
npx shadcn@latest add @tusharvarshney/twemoji
```
...
[lib/twemoji-regex.ts](https://github.com/tusharvarshney/tusharvarshney.com/blob/main/src/registry/components/twemoji/lib/twemoji-regex.ts)
