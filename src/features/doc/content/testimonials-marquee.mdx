...
image: https://assets.tusharvarshney.com/images/blog/testimonials-marquee.webp?v=2
category: components
...
<ComponentPreview
  ...
  openInV0Url="https://tusharvarshney.com/r/testimonials-marquee.json"
/>
...
```bash
npx shadcn@latest add @tusharvarshney/testimonials-marquee
```
