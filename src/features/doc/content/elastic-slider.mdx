...
image: https://assets.tusharvarshney.com/images/blog/elastic-slider.webp
category: components
new: true
...
<ComponentPreview
  ...
  openInV0Url="https://tusharvarshney.com/r/elastic-slider.json"
/>
...
```bash
npx shadcn@latest add @tusharvarshney/elastic-slider
```
