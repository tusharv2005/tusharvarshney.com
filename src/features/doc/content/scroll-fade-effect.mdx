...
image: https://assets.tusharvarshney.com/images/blog/scroll-fade-effect.webp
category: components
...
<ComponentPreview
  ...
  openInV0Url="https://tusharvarshney.com/r/scroll-fade-effect.json"
/>
...
```bash
npx shadcn@latest add @tusharvarshney/scroll-fade-effect
```
