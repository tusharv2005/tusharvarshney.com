...
image: https://assets.tusharvarshney.com/images/blog/github-stars.webp
category: components
...
<ComponentPreview
  ...
  openInV0Url="https://tusharvarshney.com/r/github-stars.json"
/>
...
```bash
npx shadcn@latest add @tusharvarshney/github-stars
```
...
```tsx
<GithubStars repo="tusharvarshney/tusharvarshney.com" stargazersCount={1800} />
```
