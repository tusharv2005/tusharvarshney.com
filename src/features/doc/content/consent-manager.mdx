...
image: https://assets.tusharvarshney.com/images/blog/consent-manager.webp
category: components
...
<IframeEmbed
  ...
  src="https://react-wheel-picker.tusharvarshney.com/sponsors"
...
```bash
npx shadcn@latest add @tusharvarshney/consent-manager
```
