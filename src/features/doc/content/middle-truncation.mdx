...
image: https://assets.tusharvarshney.com/images/blog/middle-truncation.webp
category: components
...
<ComponentPreview
  ...
  openInV0Url="https://tusharvarshney.com/r/middle-truncation.json"
/>
...
```bash
npx shadcn@latest add @tusharvarshney/middle-truncation
```
