...
image: https://assets.tusharvarshney.com/images/blog/theme-switcher-component.webp
category: components
...
<ComponentPreview
  ...
  openInV0Url="https://tusharvarshney.com/r/theme-switcher.json"
/>
...
```bash
npx shadcn@latest add @tusharvarshney/theme-switcher
```
