...
image: https://assets.tusharvarshney.com/images/blog/awesome-terminal.webp
...
Reference: https://github.com/tusharvarshney/tusharvarshney.zsh-theme

```bash
git clone git@github.com:tusharvarshney/tusharvarshney.zsh-theme.git ${ZSH_CUSTOM:-~/.oh-my-zsh/custom}/themes/tusharvarshney.zsh-theme
```

**Activate the theme**

```bash title="~/.zshrc"
ZSH_THEME="tusharvarshney.zsh-theme/tusharvarshney"
```
