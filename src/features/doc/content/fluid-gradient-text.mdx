...
image: https://assets.tusharvarshney.com/images/blog/fluid-gradient-text.webp
category: components
new: true
...
<ComponentPreview
  ...
  openInV0Url="https://tusharvarshney.com/r/fluid-gradient-text.json"
  customizeUrl="https://tusharvarshney.com/preview/fluid-gradient-text-dialkit-demo"
/>
...
```bash
npx shadcn@latest add @tusharvarshney/fluid-gradient-text
```
