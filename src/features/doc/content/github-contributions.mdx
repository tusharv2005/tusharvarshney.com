...
image: https://assets.tusharvarshney.com/images/blog/github-contributions.webp
category: components
new: true
...
<ComponentPreview
  ...
  openInV0Url="https://tusharvarshney.com/r/github-contributions.json"
/>
...
```bash
npx shadcn@latest add @tusharvarshney/github-contributions
```
