...
image: https://assets.tusharvarshney.com/images/blog/theme-toggle-effect.webp
category: components
new: true
...
```bash
npx shadcn@latest add @tusharvarshney/theme-toggle-effect-triangle
```

### Triangle Blur

```bash
npx shadcn@latest add @tusharvarshney/theme-toggle-effect-triangle-blur
```

### Circle

```bash
npx shadcn@latest add @tusharvarshney/theme-toggle-effect-circle
```

### Circle Blur

```bash
npx shadcn@latest add @tusharvarshney/theme-toggle-effect-circle-blur
```

### Circle Blur (Top Left)

```bash
npx shadcn@latest add @tusharvarshney/theme-toggle-effect-circle-blur-top-left
```

### Polygon

```bash
npx shadcn@latest add @tusharvarshney/theme-toggle-effect-polygon
```

### Polygon Gradient

```bash
npx shadcn@latest add @tusharvarshney/theme-toggle-effect-polygon-gradient
```
