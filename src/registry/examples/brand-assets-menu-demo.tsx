  ...
  return (
    <div className="flex flex-col items-center gap-4">
      <BrandAssetsMenu
        ...
        brandGuidelinesURL="https://tusharvarshney.com/blog/tushar-brand"
        brandAssetsURL="https://assets.tusharvarshney.com/tushar-brand.zip"
      >
        <Link href="/" aria-label="Home">
          <TusharMark className="h-8 text-foreground" />
        </Link>
      </BrandAssetsMenu>
...
function TusharMark(props: React.ComponentProps<"svg">) {
  return (
    <svg
