export const registryConfig = {
   ...
   * @example "@tusharvarshney" - Users can install components with: `npx shadcn add @tusharvarshney/wheel-picker`
   * @see https://ui.shadcn.com/docs/registry/namespace#overview
   */
  namespace: process.env.NEXT_PUBLIC_REGISTRY_NAMESPACE || "@tusharvarshney",
  /**
   * URL pattern for resolving namespaced components
   * The {name} placeholder will be replaced with the component name
   * @example "https://tusharvarshney.com/r/{name}.json" resolves to "https://tusharvarshney.com/r/wheel-picker.json"
  ...
  namespaceUrl:
    ...
    "https://tusharvarshney.com/r/{name}.json",
}
