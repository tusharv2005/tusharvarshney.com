...
```bash
git clone https://github.com/tusharvarshney/tusharvarshney.com.git minimal-dev-portfolio
...
The application should now be available at https://tusharvarshney.localhost
...
If you're working on a different React project and want to reuse the custom components from this repository, visit [tusharvarshney.com/components](https://tusharvarshney.com/components) for installation instructions and component documentation.
